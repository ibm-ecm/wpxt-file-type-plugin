 ...
 * @copyright IBM 2017
 */
public class WpxtFileTypePlugin extends Plugin {
	...
	public String getName(Locale locale) {
		ResourceBundle bundle = ResourceBundle.getBundle("com.ibm.icn.extensions.wpxtfiletype.nls.messages", locale, this.getClass().getClassLoader());
	...
	public String getConfigurationDijitClass() {
		return "wpxtFileTypePluginDojo.ConfigurationPane";
	}
    ...
    public com.ibm.ecm.extension.PluginService[] getServices() {
    	return new com.ibm.ecm.extension.PluginService[]{new FetchWPXTFileTypesService()};
    }
